...
public class CheckBoxLayout extends LinearLayout {
    ...
    private void init(Context context, @Nullable AttributeSet attrs){
        ...
        justifyAlign = array.getBoolean(R.styleable.CheckBoxLayout_justify_align,true);
        checkboxSelector = array.getResourceId(R.styleable.CheckBoxLayout_checkbox_selector,R.drawable.bg_circle);
        textSelector = array.getResourceId(R.styleable.CheckBoxLayout_text_selector,R.drawable.bg_circle_text_color);
        array.recycle();
    ...
    private void generate(List<String> contents){
        ...
        for (String content:contents){
            ...
            if ( justifyAlign ){
                ...
                if ((widthTemp + checkBox.getLayoutParams().width + defaultGrap) > width) {
    ...
    private CheckBox generateCheckBox(String content){
        ...
        checkBox.setBackgroundResource(checkboxSelector);
        @SuppressLint("ResourceType") ColorStateList list = getResources().getColorStateList(textSelector);
