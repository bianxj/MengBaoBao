...
import com.jcodecraeer.xrecyclerview.IArrowRefreshHeader;

public class XRefreshCustomerHeader extends LinearLayout implements IArrowRefreshHeader {
...
//    private SimpleViewSwitcher mProgressBar;
    ...
    public XRefreshCustomerHeader(Context context) {
        super(context);
        initView();
    }

    public XRefreshCustomerHeader(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
    ...
    private void initView() {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(
                R.layout.xrefresh_customer_header, null);
...
//    }
    ...
    public void setState(int state) {
        ...
        } else if(state == STATE_DONE||state == STATE_FAILED) {
            mArrowImageView.setVisibility(View.INVISIBLE);
            stopLoading();
        } else {	// 显示箭头图片
        ...
        switch(state){
            ...
            case    STATE_DONE:
                ...
                break;
            case STATE_FAILED:
                mStatusTextView.setText(com.jcodecraeer.xrecyclerview.R.string.loading_failed);
            default:
        }
