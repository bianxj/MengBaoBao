...
//            bt_choose.setVisibility(View.GONE);
    ...
    private void switchToPay(){
        ...
        intent.putExtra(PayActivity.IN_PARAM_DOCTOR_ID,doctor.getDoctorid());
    ...
    private void buyCheck(){
        task = new RefundCheckTask(this, RefundCheckTask.RefundType.BUY.BUY, new RefundCheckTask.RefundCallBack() {
            @Override
            public void success() {
                switchToPay();
            }
...
//            object.put("totalamout","24");
//            object.put("numberOfTimes","12");
////            object.put("totalamout",doctor.getCost());
////            object.put("numberOfTimes","1");
