...
public class ResponseErrorCode {
    ...
    //服务器
    public static final int ERROR_SERVER_MAINTENANCE = -1;				//服务器正在维护
    public static final int ERROR_SERVER_NOT_RESPONDING = -2;			//服务器没有响应
    public static final int ERROR_SERVER_BUSY = -3;						//服务器繁忙
    public static final int ERROR_SERVER_FULL = -4;						//服务器人数已满

    //申请账号
    public static final int ERROR_TWO_INPUTS = -10;						//新密码和老密码一样
    public static final int ERROR_ROLE_NAME_ILLEGAL = -11;				//非法的角色名
    public static final int ERROR_ROLE_NAME_SHORT = -12;				//角色名太短
    public static final int ERROR_ROLE_NAME_LONG = -13;					//角色名太长
    public static final int ERROR_PASSWORD_ILLEGAL = -14;				//非法的密码
    public static final int ERROR_PASSWORD_SHORT = -15;					//密码太短
    public static final int ERROR_PASSWORD_LONG = -16;					//密码太长
    public static final int ERROR_REGISTER_LOGINNAME_EXIST= -18;		//账号已存在
    public static final int ERROR_REGISTER_INIT_MISSION= -19;			//账号已存在

    //登陆
    public static final int ERROR_LOGIN_WRONG_PASSWORD = -20;			//密码错误
    public static final int ERROR_LOGIN_ROLE_NOT_EXIST = -21;			//账号不存在
    public static final int ERROR_LOGIN_ROLE_NAME_EMPTY = -22;			//账号名为空
    public static final int ERROR_LOGIN_ROLE_PWD_EMPTY = -23;			//密码为空
    public static final int ERROR_LOGIN_STOP = -24;						//账号禁用
    public static final int ERROR_LOGIN_LIMIT = -25;					//账号合同已到期
    public static final int ERROR_LOGIN_START = -26;					//账号合同未开始
    public static final int ERROR_LOGIN_NORECORD = -27;					//账号合同未开始
    public static final int ERROR_LOGIN_ROLE_EXIST = -900;				//登陆超时，角色需重新登录

    //注册验证码
    public static final int ERROR_VCODE_WRONG = -50;					//输入的校验码与发送验证码不一致
    public static final int ERROR_CHECKCODE_EMPTY = -51;				//校验码为空
    public static final int ERROR_VCODE_SEND = -52;						//未发送验证码
    public static final int ERROR_PHONENUMBER = -53;					//手机号格式有误
    public static final int ERROR_REGISTER_ROLE_EXIST = -54;			//注册账号已存在

    //角色
    public static final int ERROR_ROLE_GET = -100;						//角色获得失败
    public static final int ERROR_ROLE_RECORD = -101;					//角色获取当月在线记录数据错误
    public static final int ERROR_ROLE_RECORD_TIME = -102;				//角色提交记录时间已超过,需联系客服
    public static final int ERROR_ROLE_SUBMIT_FEEDBACK = -103;			//角色提交反馈失败
    public static final int ERROR_ROLE_SUBMIT_PWD = -104;				//角色提交密码错误
    public static final int ERROR_ROLE_ACCOUNT_EMAIL = -105;			//角色提交绑定邮箱错误
    public static final int ERROR_ROLE_UPDATE_PARENT = -106;			//角色修改父母信息错误
    public static final int ERROR_ROLE_UPDATE_CARER = -107;				//角色修改照养人信息错误
    public static final int ERROR_ROLE_RECORD_STATUS = -108;			//角色记录状态为已提交,不能重复提交//抱歉，提交日未到，不能提交。
    public static final int ERROR_ROLE_UPLOAD_HEAD = -109;				//角色头像上传失败
    public static final int ERROR_ROLE_BODYCHECK_MAX = -110;			//角色体检次数到达上限
    public static final int ERROR_ROLE_TREAT_MAX = -111;				//角色治疗次数到达上限
    public static final int ERROR_ROLE_SALON_MAX = -112;				//角色沙龙次数到达上限
    public static final int ERROR_ROLE_MENU = -113;						//角色套餐信息获得失败
    public static final int ERROR_ROLE_MENU_LIMIT = -114;				//角色套餐即将失效
    public static final int ERROR_ROLE_MENU_OVER = -115;				//角色套餐结束
    public static final int ERROR_ROLE_UPDATE_LINKMAN = -116;			//角色修改联系人信息错误

    //客户端
    public static final int ERROR_CLIENT_PARAMS_EMPTY = -200;			//空参数
    public static final int ERROR_CLIENT_PARAM_FORMAT = -201;			//客户端参数格式错误
    public static final int ERROR_CLIENT_PARAM_COUNT = -202;			//客户端参数数目错误

    //其他
    public static final int ERROR_UNKNOWN = -300;						//未知错误
    public static final int ERROR_MEMCACHE_DATA_NOT_EXIST = -301;		//没有相应的缓存数据
    public static final int ERROR_ILLEGAL_OPERATION = -302;				//非法操作
    public static final int ERROR_COULD_NOT_CONNECT_TO_HOST = -303;		//网络延迟
    public static final int ERROR_WRONG_DATA_STRUCT = -304;				//错误的数据结构
    public static final int ERROR_SENDCODE_UPPERLIMIT = -305;			//短信超上限

    //数据库
    public static final int ERROR_DB_INSERT = -500;						//数据库插入数据失败
    public static final int ERROR_DB_RECORD_HELP = -501;				//数据库获取在线月记录规则失败

    public static final int ERROR_REQUEST_FAILED = -10000;
