...
//    }
    ...
    public void setFootView(@NonNull final BaseLoadMoreFooter view) {
        if(view == null){
            return;
        }
        mFootView = view;
    ...
    public void setNoMore(boolean noMore){
        isLoadingData = false;
        isNoMore = noMore;
        mFootView.setState(isNoMore ? BaseLoadMoreFooter.STATE_NOMORE:BaseLoadMoreFooter.STATE_COMPLETE);
    }
    public void refresh() {
